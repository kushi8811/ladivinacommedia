...
const ReservationsContainer = () => {
  return (
    <div className="relative  w-[85%] sm:w-[95%] ml-8 h-[75vh] rounded-2xl flex items-center mr-2 justify-center bg-primary-50 py-16 sm:py-24">
      ...
      >
        ...
        <div className="relative text-center text-white p-10 sm:p-8 max-w-lg mt-28 sm:mt-32 md:mt-40">
          ...
          <p
            className={`${mono.className} text-gray-300 text-sm sm:text-lg mt-2 opacity-80 mb-4`}
          >
          ...
          <Link
            className="sm:mt-6 px-6 py-2  border-2 text-primary-50  font-bold border-primary-50  
