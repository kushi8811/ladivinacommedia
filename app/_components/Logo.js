...
function Logo() {
  return (
    ...
    >
      ...
      <div className="mt-7 absolute top-2 left-14 bg-transparent items-center justify-center flex border-2 border-accent-500 shadow-lg hover:bg-accent-500 text-accent-500 hover:text-white duration-300 cursor-pointer active:scale-[0.98]">
        <button className="px-2 py-0 text-sm">
          <Link href="/booking">Book now</Link>
        </button>
      </div>
      {/* COOKING CLASS Button placed on the right */}
      <div className="mt-7 absolute top-2 right-4 bg-transparent items-center justify-center flex border-2 border-accent-500 shadow-lg hover:bg-accent-500 text-accent-500 hover:text-white duration-300 cursor-pointer active:scale-[0.98]">
        <button className="px-2 py-0 text-sm">
          <Link href="/cooking">Cooking Class</Link>
        </button>
      </div>
    </div>
  );
