...
export default function ContactForm() {
  ...
  return (
    <div className="relative w-[85%] items-center justify-center sm:w-[95%] ml-8 h-[75vh] rounded-2xl max-w-lg mx-auto border border-primary-50 p-6 bg-white shadow-lg mt-[75px] pt-10 mb-4 pb-6">
